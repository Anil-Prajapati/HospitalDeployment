...
public class AdminService {
    ...
    public Admin create(Admin doctor) {
        ...
        log.info("Doctor account created successfully for: {}", doctor.getDoctorName());
    ...
    public Admin update(int id, String shiftTime, int doctorFee) {
        ...
        log.info("Updated doctor information for ID {}: ShiftTime - {}, Doctor Fee - {}", id, shiftTime, doctorFee);
    ...
    public void DeleteData(Integer id) {
        ...
        log.info("Deleted doctor record with ID: {}", id);
    }
}
